...
void TrackDescriptor::feed_monocular(const CameraData &message, size_t msg_id) {
  ...
  // sougato_debug
  // std::cout<<"#####Stereo descriptor module start#####\n";
  // std::cout<<"Time for detection ["<<(rT2-rT1) * 1e-6<<"]\n";
  // std::cout<<"Time for matching ["<<(rT3-rT2) * 1e-6<<"]\n";
  // std::cout<<"Time for merging ["<<(rT4-rT3) * 1e-6<<"]\n";
